 ...
 */
@Service
public class AgentAvailabilityManager implements AvailabilityManagerService {

    private final DeliveryAgentDao deliveryAgentDao;
    public static final String MESSAGE = "Failed, Unable to reach database";

    /**
     * Constructs an AgentAvailabilityManager with the required DAO
     *
     * @param deliveryAgentDao DAO for delivery agent operations
     */
    public AgentAvailabilityManager(final DeliveryAgentDao deliveryAgentDao) {
